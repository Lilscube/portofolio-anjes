...
// 1. Kamus Bahasa Inggris (Default)
export const en = {
  nav: {
    about: "About",
    projects: "Projects",
...
// 2. Ekspor tipe Translations berdasarkan struktur bahasa Inggris
export type Translations = typeof en;

// 3. Kamus Bahasa Indonesia (Memastikan struktur cocok dengan tipe Translations)
